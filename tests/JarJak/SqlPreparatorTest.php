...
class SqlPreparatorTest extends TestCase
{
     ...
     */
    public function testInsertOrUpdate($data, $sql, $params)
    {
    ...
    public function insertOrUpdateDataProvider()
    {
        return [
            ...
            [
                'data' => ['user' => 'vuser', 'key' => 'vkey', 'order' => 'vorder', 'group' => 'vgroup'],
    ...
    public function testInsertOrUpdateIgnoreColumn()
    {
        $data = ['a' => 'av', 'b' => '0', 'c' => 'cv', 'd' => 'dv'];
     ...
     */
    public function testInsertIgnore($data, $sql, $params)
    {
     ...
     */
    public function testMultiInsertOrUpdate($data, $sql, $params)
    {
    ...
    public function multiInsertOrUpdateDataProvider()
    {
        return [
            ...
            [
                'data' => [['a' => 'av', 'b' => '0', 'c' => 'cv', 'd' => 'dv'], ['a' => 'av', 'b' => 'bv', 'c' => '', 'd' => 'dv']],
     ...
     */
    public function testMultiInsert($data, $sql, $params)
    {
     ...
     */
    public function testMultiInsertIgnore($data, $sql, $params)
    {
